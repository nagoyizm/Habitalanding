      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 w-full">
        <AnimatedSection className="text-center max-w-3xl mx-auto mb-10 md:mb-12">
          ...
          <p className="text-base md:text-lg text-stone-700 font-medium">
            Habita está diseñado para eliminar el caos diario de la gestión de alojamientos, uniendo todas tus herramientas en un flujo de trabajo increíblemente suave.
          </p>
        </AnimatedSection>
